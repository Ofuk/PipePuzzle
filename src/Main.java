...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        // CardLayout to switch between start and game panels
    ...
    // Start Panel (Initial screen with Start button)
    private void createStartPanel() {
        ...
        level1Button.addActionListener(e -> startGame(4, "level1")); // Start game with 4x4 grid
        ...
        level2Button.addActionListener(e -> startGame(4, "level2")); // Start game with 4x4 grid
        ...
        level3Button.addActionListener(e -> startGame(4, "level3")); // Start game with 4x4 grid
    ...
    private void createGamePanel() {
        ...
        backButton.addActionListener(e -> cardLayout.show(getContentPane(), "START")); // Go back to start panel

        JButton nextButton = new JButton("Next");
        nextButton.setFont(new Font("Arial", Font.BOLD, 18));
        nextButton.setBackground(Color.GREEN);
        nextButton.setForeground(Color.WHITE);
        nextButton.addActionListener(e -> goToNextLevel()); // Go to next level
    ...
    private String getCurrentLevel() {
        ...
        return "level1"; // Default to level 1 if not found
    }

    // Start game with specified grid size and level
    private void startGame(int size, String level) {
        ...
        // Load images for each position based on level
    ...
    private ImageIcon[][] loadImagesForLevel(String level) {
        ...
        String basePath = "D:\\CODINGAN\\ProjekUAS\\Images\\";
    ...
    private void rotateImage(int row, int col, String level) {
        ...
        if (originalIcon != null) {
            ...
            // Check if all specified images have been rotated once in level 1
